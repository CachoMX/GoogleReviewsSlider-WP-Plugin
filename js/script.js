...
jQuery(document).ready(function($) {
    ...
    function initSlider() {
        ...
        $slider.slick({
            ...
            slidesToScroll: 1,
            adaptiveHeight: true,
            arrows: true,              // CHANGED: Enable arrows
            autoplay: true,
            autoplaySpeed: 3000,
            pauseOnHover: true,
            pauseOnFocus: true,
            prevArrow: '<button type="button" class="slick-prev">←</button>',  // Custom arrow
            nextArrow: '<button type="button" class="slick-next">→</button>',  // Custom arrow
            responsive: [
                {
                    breakpoint: 1024,
                    settings: {
